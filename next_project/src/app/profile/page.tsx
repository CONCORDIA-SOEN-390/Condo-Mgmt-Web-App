...
function ProfilePage() {
  ...
  return (
    <div className="flex min-h-screen-nav items-center justify-center h-full bg-white overflow-y-auto">
      ...
      <div className="fixed ml-50 bottom-0 left-0 right-0 flex justify-center">
