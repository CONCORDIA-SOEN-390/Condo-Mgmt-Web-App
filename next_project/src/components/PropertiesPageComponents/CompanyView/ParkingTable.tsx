    ...
    const handleRegistration = async () => {
        try {
            const response = await fetch('/api/handleParkingRegistration', {
                ...
                body: JSON.stringify({ propertyId: propertyIdInput, parkingOwnerId: parkingOwnerIdInput, parkingId: parkingIdInput, parkingFee: parkingFeeInput }),
            });
