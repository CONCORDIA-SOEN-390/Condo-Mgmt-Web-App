        ...
        <div className="flex flex-wrap justify-center">
            ...
            <div className="text-center mt-2 text-white text-xl font-semibold">
                ...
                <Link href={"properties"} className={page==='properties'? 'text-blue-600': ' text-white'}>
                    <FaHouse className="ml-10 mt-2 text-3xl" />
                    Condo Units
                </Link>
                ...
                <Link href={"reservations"} className={page==='reservations'? 'text-blue-600': ' text-white'}>
                    <FaCalendar className="ml-10 mt-2 text-3xl" />
                    Reservations
                </Link>
