      ...
      <div className="w-5/12  rounded-2xl p-6 ">
        ...
        <div className="mb-6 ">
          ...
          <div className="flex items-center mt-6">
            ...
            <input
              type="checkbox"
              className="ml-3 checkbox checkbox-xs border-slate-500"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          className="mb-8 bg-yellow-950 hover:bg-yellow-900 text-white py-2 px-16 rounded m-auto block shadow-sm"
        >
          Submit
        </button>
      </div>
