...
const Navbar = () => {
  return (
    <div className="flex justify-center w-full overflow-hidden fixed top-0 pb-3 bg-gradient-to-b from-sky-50 to-transparent">
      <div className="absolute inset-0 text-[#332d2d] text-2xl font-bold pt-5 ml-8">
        <a href="/">Condo360</a>
      </div>

      <div className="flex mx-auto">
        <ul className="flex list-none m-0 p-0 w-full z-10">
          <li>
