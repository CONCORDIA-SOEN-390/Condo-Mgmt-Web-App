      ...
      <div className='absolute grid grid-rows-3 w-5/6 right-5 gap-5'>
        <div className="bg-white shadow-lg rounded-xl ">
          <div className='grid grid-cols-2 bg-sky-300 rounded-t-lg'>
            <div className='p-2 font-semibold text-white text-2xl'>Personal Information</div>
            <div className='p-2 flex justify-end items-center'><MdEditSquare className='text-white text-3xl' /></div>
          </div>
          <div className="grid grid-cols-2 grid-rows-3 gap-5 p-5 text-black text-xl">
            ...
            <div className="row-start-2 flex justify-end items-center">john_smith@gmail.com</div>
            <div className="row-start-3">Phone Number:</div>
            <div className="row-start-3 flex justify-end items-center">(514) 123-4567</div>
          </div>
        </div>
        <div className="bg-white shadow-lg rounded-xl ">
          <div className='bg-sky-300 rounded-t-lg p-2 font-semibold text-white text-2xl'>Finances</div>
          <div className='p-16 text-black text-xl text-center'>SOME INFO ON THE FINANCES</div>
        </div>
        <div className="bg-white shadow-lg rounded-xl ">
          <div className='bg-sky-300 rounded-t-lg p-2 font-semibold text-white text-2xl'>Properties</div>
